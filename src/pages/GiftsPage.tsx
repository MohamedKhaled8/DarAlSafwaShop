    ...
    <main className="pb-20 lg:pb-0">
      <div className="section-padding py-8">
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
          <h1 className="text-2xl md:text-3xl font-bold mb-2">Custom Gifts</h1>
          <p className="text-sm text-muted-foreground mb-8">Create personalized gifts with custom text and images</p>
        </motion.div>

        <div className="lg:flex gap-8">
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="flex-1 space-y-6">
            <div>
              <label className="text-sm font-medium block mb-2"><Type className="w-4 h-4 inline mr-1" /> Custom Text</label>
              <input
                type="text"
                value={text}
            ...
            <div>
              <label className="text-sm font-medium block mb-2"><Upload className="w-4 h-4 inline mr-1" /> Upload Image</label>
