...
const translations: Record<Language, Record<string, string | Record<string, string>>> = {
  ar: {
    ...
    "nav.trackOrders": "تابع طلباتك",
    "nav.noCategories": "لا توجد أقسام بعد",
    "nav.language": "اللغة",
    "theme.label": "المظهر: فاتح أو داكن",
    "theme.light": "فاتح",
    "theme.dark": "داكن",
    "theme.system": "حسب النظام",
    "orders.statusPending": "قيد المراجعة",
    "orders.statusProcessing": "جاري التجهيز",
    "orders.statusApprovedProcessing": "تمت الموافقة على الطلب وجاري التجهيز",
    "orders.statusShipped": "تم الشحن",
    "orders.statusDelivered": "تم التوصيل",
    "orders.statusCancelled": "ملغي",
    "orders.refLabel": "مرجع الطلب",
    "orders.dateLabel": "التاريخ",
    "orders.products": "المنتجات",
    "orders.viewInvoice": "عرض الفاتورة",
    "orders.paid": "تم الدفع",
    "myOrders.title": "طلباتي",
    "myOrders.subtitle": "تابع حالة طلباتك ومشترياتك السابقة",
    "myOrders.back": "العودة للمتجر",
    "myOrders.emptyTitle": "لا توجد طلبات بعد",
    "myOrders.emptyDesc": "لم تقم بشراء أي منتجات حتى الآن. ابدأ بتصفح منتجاتنا وضع طلبك الأول!",
    "myOrders.browse": "تصفح المنتجات",
    ...
    "home.categoriesStripTitle": "تصفح الفئات",
    ...
    "checkout.customerDetails": "بيانات العميل",
    "checkout.fullName": "الاسم الكامل",
    "checkout.email": "البريد الإلكتروني",
    "checkout.emailOptional": "(اختياري)",
    "checkout.phone": "رقم الهاتف",
    "checkout.altPhone": "هاتف بديل",
    "checkout.altPhonePlaceholder": "رقم ثانٍ اختياري",
    "checkout.nationalId": "الرقم القومي",
    "checkout.nationalIdPlaceholder": "١٤ رقماً",
    "checkout.deliveryMethod": "طريقة الاستلام",
    "checkout.pickupTitle": "استلام من المكتبة",
    "checkout.pickupDesc": "مجاني — تستلم من الفرع",
    "checkout.shippingTitle": "شحن للمنزل",
    "checkout.shippingDesc": "التوصيل لعنوانك",
    "checkout.selectGovernorate": "اختر المحافظة",
    "checkout.selectGovernoratePlaceholder": "اختر محافظتك",
    "checkout.paymentMethod": "طريقة الدفع",
    "checkout.vodafoneCash": "فودافون كاش",
    "checkout.instapay": "إنستاباي",
    "checkout.transferTo": "حوّل إلى",
    "checkout.stepTransfer": "حوّل المبلغ التالي إلى الطريقة التي اخترتها:",
    "checkout.stepUpload": "ارفع صورة إيصال الدفع أو لقطة شاشة",
    "checkout.copy": "نسخ",
    ...
    "checkout.shippingFreePickup": "مجاني (استلام)",
    "checkout.shippingSelectGov": "اختر المحافظة",
    "checkout.total": "الإجمالي",
    "checkout.placeOrder": "تأكيد الطلب",
    "checkout.processing": "جاري المعالجة...",
    "checkout.loginRequired": "يجب تسجيل الدخول لإتمام الطلب.",
    "checkout.selectGovError": "يرجى اختيار المحافظة للشحن.",
    "checkout.receiptRequired": "يجب رفع إيصال الدفع قبل إتمام الطلب.",
    "checkout.nationalIdError": "أدخل الرقم القومي (١٤ رقماً).",
    "checkout.orderSuccess": "تم تسجيل الطلب بنجاح!",
    "checkout.orderFailed": "تعذر إتمام الطلب.",
    "checkout.uploadingReceipt": "جاري رفع الإيصال...",
    "checkout.receiptUploaded": "تم رفع الإيصال.",
    "checkout.uploadFailed": "فشل رفع الإيصال.",
    "checkout.receiptPreview": "معاينة الإيصال",
    "invoice.title": "تم تأكيد الطلب",
    "invoice.subtitle": "شكراً لشرائك. هذه فاتورتك.",
    "invoice.billedTo": "الفاتورة إلى",
    "invoice.details": "تفاصيل الفاتورة",
    "invoice.orderId": "رقم الطلب",
    "invoice.date": "التاريخ",
    "invoice.delivery": "التوصيل",
    "invoice.pickup": "استلام من الفرع",
    "invoice.shipping": "شحن",
    "invoice.paymentMethod": "طريقة الدفع",
    "invoice.paymentStatus": "حالة الدفع",
    "invoice.email": "البريد",
    "invoice.phone": "الهاتف",
    "invoice.altPhone": "هاتف بديل",
    "invoice.nationalId": "الرقم القومي",
    "invoice.items": "العناصر",
    "invoice.qty": "الكمية",
    "invoice.unitPrice": "سعر الوحدة",
    "invoice.lineTotal": "الإجمالي",
    "invoice.subtotal": "المجموع الفرعي",
    "invoice.shippingFee": "الشحن",
    "invoice.free": "مجاني",
    "invoice.total": "الإجمالي",
    "invoice.receipt": "إيصال الدفع",
    "invoice.viewReceipt": "عرض الإيصال",
    "invoice.back": "العودة للمتجر",
    "invoice.print": "طباعة",
    "invoice.savePdf": "حفظ PDF",
    ...
    "dashboard.viewInvoice": "عرض الفاتورة",
    ...
    "login.welcomeBack": "تم تسجيل الدخول بنجاح — أهلاً بك من جديد!",
    ...
    "adminPrinting.pricingTitle": "إعدادات أسعار الطباعة",
    "adminPrinting.pricingDesc": "حدد سعر كل حجم ورق ونوع ورق. يُجمع السعران ثم يُضرب في عدد النسخ، مع إضافة فرق الألوان/الأبيض والأسود لكل نسخة.",
    "adminPrinting.pricingSizes": "أحجام الورق والسعر (لكل نسخة)",
    "adminPrinting.pricingTypes": "أنواع الورق والسعر (لكل نسخة)",
    "adminPrinting.addRow": "إضافة صف",
    "adminPrinting.priceShort": "سعر",
    "adminPrinting.colorExtra": "زيادة الطباعة الملونة (لكل نسخة)",
    "adminPrinting.bwExtra": "زيادة الأبيض والأسود (لكل نسخة)",
    "adminPrinting.pricingFormula": "المعادلة: (سعر الحجم + سعر نوع الورق + زيادة نوع الطباعة) × عدد النسخ.",
    "adminPrinting.savePricing": "حفظ الأسعار",
    "adminPrinting.pricingSaved": "تم حفظ إعدادات الطباعة",
    "adminPrinting.pricingNeedRows": "أضف صفاً واحداً على الأقل لحجم الورق ولنوع الورق (مع اسم عربي أو إنجليزي).",
    ...
    "adminShipping.saveFailed": "تعذر حفظ سعر الشحن.",
    "adminShipping.deleteFailed": "تعذر حذف سعر الشحن.",
    "adminShipping.statusFailed": "تعذر تحديث حالة الشحن.",
  ...
  en: {
    ...
    "nav.trackOrders": "Track your orders",
    "nav.noCategories": "No categories yet",
    "nav.language": "Language",
    "theme.label": "Theme: light or dark",
    "theme.light": "Light",
    "theme.dark": "Dark",
    "theme.system": "System",
    "orders.statusPending": "Pending review",
    "orders.statusProcessing": "Processing",
    "orders.statusApprovedProcessing": "Order approved — processing",
    "orders.statusShipped": "Shipped",
    "orders.statusDelivered": "Delivered",
    "orders.statusCancelled": "Cancelled",
    "orders.refLabel": "Order reference",
    "orders.dateLabel": "Date",
    "orders.products": "Products",
    "orders.viewInvoice": "View invoice",
    "orders.paid": "Paid",
    "myOrders.title": "My orders",
    "myOrders.subtitle": "Track your orders and past purchases",
    "myOrders.back": "Back to store",
    "myOrders.emptyTitle": "No orders yet",
    "myOrders.emptyDesc": "You have not placed any orders yet. Browse our catalog and place your first order!",
    "myOrders.browse": "Browse products",
    ...
    "home.categoriesStripTitle": "Browse categories",
    ...
    "checkout.emailOptional": "(optional)",
    "checkout.phone": "Phone number",
    "checkout.altPhone": "Alternative phone",
    "checkout.altPhonePlaceholder": "Optional second number",
    "checkout.nationalId": "National ID",
    "checkout.nationalIdPlaceholder": "14-digit national ID",
    "checkout.deliveryMethod": "Delivery method",
    "checkout.pickupTitle": "Store pickup",
    "checkout.pickupDesc": "Free — pick up at the store",
    "checkout.shippingTitle": "Home delivery",
    "checkout.shippingDesc": "Delivered to your address",
    "checkout.selectGovernorate": "Select governorate",
    "checkout.selectGovernoratePlaceholder": "Choose your governorate",
    "checkout.paymentMethod": "Payment method",
    "checkout.vodafoneCash": "Vodafone Cash",
    "checkout.instapay": "InstaPay",
    "checkout.transferTo": "Transfer to",
    "checkout.stepTransfer": "Transfer the following amount using the method you selected:",
    "checkout.stepUpload": "Upload a payment receipt or screenshot",
    "checkout.copy": "Copy",
    ...
    "checkout.shippingFreePickup": "Free (pickup)",
    "checkout.shippingSelectGov": "Select governorate",
    "checkout.total": "Total",
    "checkout.placeOrder": "Place order",
    "checkout.processing": "Processing...",
    "checkout.loginRequired": "You must be logged in to place an order.",
    "checkout.selectGovError": "Please select a governorate for shipping.",
    "checkout.receiptRequired": "You must upload a payment receipt before checkout.",
    "checkout.nationalIdError": "Please enter a valid national ID (14 digits).",
    ...
    "dashboard.viewInvoice": "View invoice",
    ...
    "login.welcomeBack": "Signed in successfully — welcome back!",
    ...
    "adminPrinting.pricingTitle": "Print pricing settings",
    "adminPrinting.pricingDesc": "Set a price for each paper size and paper type. Size + type add together, then multiply by copies, plus the color/B&W extra per copy.",
    "adminPrinting.pricingSizes": "Paper sizes (per copy)",
    "adminPrinting.pricingTypes": "Paper types (per copy)",
    "adminPrinting.addRow": "Add row",
    "adminPrinting.priceShort": "EGP",
    "adminPrinting.colorExtra": "Color print extra (per copy)",
    "adminPrinting.bwExtra": "B&W print extra (per copy)",
    "adminPrinting.pricingFormula": "Formula: (size price + paper type price + print mode extra) × number of copies.",
    "adminPrinting.savePricing": "Save pricing",
    "adminPrinting.pricingSaved": "Print pricing saved",
    "adminPrinting.pricingNeedRows": "Add at least one paper size and one paper type row (Arabic or English label).",
    ...
    "adminShipping.saveFailed": "Could not save shipping rate.",
    "adminShipping.deleteFailed": "Could not delete shipping rate.",
    "adminShipping.statusFailed": "Could not update shipping status.",
